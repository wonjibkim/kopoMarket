...
<section class="contact-form section-padding3">
    <div class="login-page">
        <div class="form">
            ...
            <br>
            <form class="login-form" method="post" action="/login/ForgotPwdUser/userPCodeCheck" onsubmit="return doLoginUserCheck(this);">
                <p> 이메일로 전송된 코드를 입력해주세요. </p>
                <input type="text" name="pwd_code" placeholder="pwd_code"/>
                <button type="submit" value="Check Pwd"><font size="2em"> 코드 확인하고 비밀번호 변경하기</font> </button>

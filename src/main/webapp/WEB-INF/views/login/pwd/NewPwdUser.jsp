...
<section class="contact-form section-padding3">
    <div class="login-page">
        <div class="form">
            ...
            <br>
            <form class="login-form" method="post" action="/login/ForgotPwdUser/newPwdUser" onsubmit="return doLoginUserCheck(this);">
                <p> 새로운 비밀번호를 입력해주세요 </p>
                <input type="password" name="newPwd1" placeholder="새로운 비밀번호"/>
                <input type="password" name="newPwd2" placeholder="비밀번호 확인"/>

                <button type="submit" value="Change_Pwd"><font size="2em">비밀번호 변경하기</font> </button>

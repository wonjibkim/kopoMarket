                ...
                <div class="input-group-icon mt-10">
                    ...
                    <div class="checkout__input">
                        ...
                        <div class="select">
                            ...
                            <input type="radio" id="select5" name="p_category" value="Fish" ><label for="select5">물고기</label>
...
<%--            <input type="button" id="btn" value="바코드 스캔/ 중지"  style="background-color:#7fad39; color: white; font-size: 20px; width:300px"/>--%>
        </form>
...
<%--    <form method="post" name="ex_form" action="doService" style="width:650px; margin: auto;">--%>

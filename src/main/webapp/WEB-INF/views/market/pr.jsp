...
<%--                        &lt;%&ndash;                            <img src="img/cart/cart-1.jpg" alt=""> 이미지 넣기&ndash;%&gt;--%>
<%--                        <tr>--%>
...
<%--&lt;%&ndash;                            <td class="shoping__cart__total"><%= rList.get(i).getP_period()%></td>&ndash;%&gt;--%>

<%--                            <td class="shoping__cart__total"><%= rList.get(i).getP_ancestry()%></td>--%>

<%--                            <td class="shoping__cart__item__close">--%>

<%--&lt;%&ndash;                                <a href="javascript:doDetail('<%=CmmUtil.nvl(rDTO.getP_num())%>');">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <%=CmmUtil.nvl(rDTO.getP_name())%> </a>&ndash;%&gt;--%>

...
<%--            location.href = "/market/FoodEditInfo?p_num?=";--%>
<%--        }--%>
...
<%--            $.ajax({--%>
<%--                type: 'POST',--%>
<%--                url :  "/market/FoodDeleteShelfLine",--%>
...
<%--                    <a href="/market/insert" class="primary-btn cart-btn">물품등록</a>--%>
                    <a href="/market/FoodList"  class="primary-btn cart-btn cart-btn-right"><span class="icon_loading"></span>
                        등록 물품 전체보기</a>
                </div>
                <div class="shoping__cart__btns">
                    <%--                    <a href="/market/insert" class="primary-btn cart-btn">물품등록</a>--%>
                    <a href="/market/Foodzerodel"  class="primary-btn cart-btn cart-btn-right"><span class="icon_loading"></span>
                        재고 0인것 일괄삭제하기</a>
                </div>

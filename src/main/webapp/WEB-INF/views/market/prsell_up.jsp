...
<div class="contact-form spad">
    <div class="container">
        ...
        <form name="f" method="post" action="/market/insert_St" onsubmit="return doRegUserCheck(this);"  enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-6">
                    <div class="checkout__input">
                        <p>상품명<span></span></p>
                        <input type="text" name="p_name" VALUE=" <%= rList.get(rList.indexOf(0)).getP_name()%>" >
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="checkout__input">

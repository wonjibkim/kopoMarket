...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li><a href="/ogani-master/index.html">Home</a></li>
                            <li class="active"><a href="/ogani-master/shop-grid.html">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="/ogani-master/shop-details.html">Shop Details</a></li>
                                    <li><a href="/ogani-master/shoping-cart.html">Shoping Cart</a></li>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="/ogani-master/payment-item.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>

...
public class MailService implements IMailService {
    ...
    public int doSendMail(MailDTO mDTO) {
        ...
        String email_user = CmmUtil.nvl(mDTO.getEmail_user()); //받는 사람
        //String title = CmmUtil.nvl(mDTO.getTitle()); //메일 제목
        //String contents = CmmUtil.nvl(mDTO.getContents()); //메일 내용

        log.info("toMail: " + email_user);
        ...
        try {
            messageHelper.setTo(email_user); // 받는사람

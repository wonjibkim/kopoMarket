...
//
//        } finally {
//            log.info(this.getClass().getName() + ".NoticeInert end!");
//
//
//
...
//    @GetMapping(value = "/mainsell") // 리스트 수정보기
//    public String mainsell(HttpServletRequest request, ModelMap model) {
//        log.info(this.getClass().getName() + "mainsell start");
//
//        String msg = "";
//
...
//            fDTO.setP_num(Seq);
//
//            FoodDTO rDTO = mainService.getMainsell(fDTO);
//
//            if (rDTO == null) {
//                rDTO = new FoodDTO();
//            }
...
//        //ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
//
//        log.info(this.getClass().getName() + "mainsell end");
//
//        return "/market/main_sell_up";
//    }
